...
class InterviewFlowGPT:
    ...
    def check_time_pressure_detail(self):
        if self.details["時間的プレッシャー"]:
            print("時間的プレッシャーの情報はすでに格納されています。次のステップへ進みます。")
        else:
            context = "相手はまだ具体的な時間的プレッシャーについて話していません。"
            focus = "その時間的プレッシャーについて尋ねてください。"
            dynamic_question = generate_dynamic_question(context, focus)
            deep_answer = input(dynamic_question)

            result = gpt_judge(deep_answer, "具体的な時間的プレッシャー")
            if result == "yes":
                self.details["時間的プレッシャー"] = deep_answer
    ...
    def second_phase_two(self):
        if self.details["気付き"]:
            ...
            context = "相手はまだ具体的な気付きについて話していません。"
            focus = "その気付きについて尋ねてください。"
            dynamic_question = generate_dynamic_question(context, focus)
            deep_answer = input(dynamic_question)
            self.details["気付き"] = deep_answer
            print("気付きの詳細を格納しました。")
    ...
    def check_goal_detail(self):
        if self.details["目的・目標"]:
            ...
            context = "相手はまだ具体的な目的や目標を話していません。"
            focus = "その目的や目標について尋ねてください。"
            dynamic_question = generate_dynamic_question(context, focus)
            deep_answer = input(dynamic_question)

            result = gpt_judge(deep_answer, "具体的な目的や目標")
            if result == "yes":
                self.details["目的・目標"] = deep_answer
    ...
    def check_prediction_detail(self):
        if self.details["事象予測"]:
            ...
            context = "相手はまだ具体的な事象予測について話していません。"
            focus = "その事象予測について尋ねてください。"
            dynamic_question = generate_dynamic_question(context, focus)
            deep_answer = input(dynamic_question)

            result = gpt_judge(deep_answer, "具体的な事象予測")
            if result == "yes":
                self.details["事象予測"] = deep_answer
    ...
    def check_knowledge_detail(self):
        if self.details["知識"]:
            print("知識の情報はすでに格納されています。次のステップへ進みます。")
            self.check_experience_detail()
        else:
            context = "相手はまだ具体的な知識について話していません。"
            focus = "その知識について尋ねてください。"
            dynamic_question = generate_dynamic_question(context, focus)
            deep_answer = input(dynamic_question)

            result = gpt_judge(deep_answer, "具体的な知識")
            if result == "yes":
                self.details["知識"] = deep_answer
                print("知識の情報を格納しました。")
                self.check_experience_detail()
    ...
    def check_experience_detail(self):
        if self.details["過去の経験"]:
            ...
            context = "相手はまだ具体的な経験について話していません。"
            focus = "その経験について尋ねてください。"
            dynamic_question = generate_dynamic_question(context, focus)
            deep_answer = input(dynamic_question)

            result = gpt_judge(deep_answer, "具体的な経験")
            if result == "yes":
                self.details["過去の経験"] = deep_answer
                print("経験の情報を格納しました。")
            else:
    ...
    def second_phase_four(self):
        if self.details["根拠"]:
            ...
            context = "相手はまだ具体的な根拠について話していません。"
            focus = "その根拠について尋ねてください。"
            dynamic_question = generate_dynamic_question(context, focus)
            deep_answer = input(dynamic_question)
            self.details["根拠"] = deep_answer
            print("根拠の詳細を格納しました。")
...
# flow_gpt.start_phase_four()  # 第四段階を開始
